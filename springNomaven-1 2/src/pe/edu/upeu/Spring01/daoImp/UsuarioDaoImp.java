...
public class UsuarioDaoImp implements UsuarioDao{
	...
	public int create(Usuario user) throws SQLException {
		...
		try {
			...
			PreparedStatement ps = cx.prepareStatement("insert into usuario(idusuario, nom_user,clave,estado) values(null,?,?,1)");
	...
	public int update(Usuario user) {
		...
		try {
			cx = dataSource.getConnection();
			PreparedStatement ps = cx.prepareStatement("UPDATE usuario SET clave=? WHERE idusuario=?");
